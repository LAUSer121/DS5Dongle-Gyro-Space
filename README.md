...
>   `ds5-v1.26.2-waveshare.uf2` now ships with each release; flash that and you're
...
1. **Flash the firmware.** *(RP2350 only — Pico 2 W and Waveshare RP2350B-Plus-W
   ...
   `ds5-v1.26.2.uf2` (Pico 2 W) or `ds5-v1.26.2-waveshare.uf2` (Waveshare) to the
...
- `ds5-v1.26.2.uf2` — the firmware for the **Raspberry Pi Pico 2 W** (flash this;
  reports version 1.26.2)
- `ds5-v1.26.2-waveshare.uf2` — the same firmware for the **Waveshare
