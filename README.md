...
▶️ **[Configure in your browser](https://artzox.github.io/DS5Dongle/ds5-config-portal.html)** — the config portal can run as a web page, no download required. Needs Chrome or Edge, with the dongle plugged in. (Goes live once GitHub Pages is enabled for this repo.)
...
>   `ds5-v1.18.21-waveshare.uf2` now ships with each release; flash that and you're
...
1. **Flash the firmware.** *(RP2350 only — Pico 2 W and Waveshare RP2350B-Plus-W
   ...
   `ds5-v1.18.21.uf2` (Pico 2 W) or `ds5-v1.18.21-waveshare.uf2` (Waveshare) to the
...
- `ds5-v1.18.21.uf2` — the firmware for the **Raspberry Pi Pico 2 W** (flash this;
  reports version 1.18.21)
- `ds5-v1.18.21-waveshare.uf2` — the same firmware for the **Waveshare
